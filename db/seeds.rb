...
Garden.create!({
    ...
    price: '10000',
    location: 'Paris',
    external_pic: 'https://res.cloudinary.com/drgdpdviq/image/upload/v1542941290/Secret gardens/versailles.jpg',
    host: User.first
})
Garden.create!({
    ...
    price: '6000',
    location: 'London',
    external_pic: 'https://res.cloudinary.com/drgdpdviq/image/upload/v1542941265/Secret%20gardens/kewgardens.jpg',
    host: User.first
})
Garden.create!({
    name: 'Sensory Garden',
    ...
    price: '200',
    location: 'Kyoto',
    external_pic: 'https://res.cloudinary.com/drgdpdviq/image/upload/v1542702105/Secret%20gardens/th-3.jpg',
    host: User.last
})
Garden.create!({
    ...
    price: '600',
    location: 'Oxford',
    external_pic: 'https://res.cloudinary.com/drgdpdviq/image/upload/v1542702099/Secret%20gardens/th-8.jpg',
    host: User.last
})
Garden.create!({
    ...
    price: '300',
    location: 'Shanghai',
    external_pic: 'https://res.cloudinary.com/drgdpdviq/image/upload/v1542702100/Secret%20gardens/French-Country-Garden-Design-2.jpg',
    host: User.first
})
Garden.create!({
    ...
    price: '500',
    location: 'Kyoto',
    external_pic: 'https://res.cloudinary.com/drgdpdviq/image/upload/v1542702103/Secret%20gardens/th.jpg',
    host: User.last
})
